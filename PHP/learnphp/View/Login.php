...
<head>
    ...
    <!-- BEGIN THEME STYLES -->
    <link href="../metronic/theme/assets/global/css/components-rounded.css" id="style_components" rel="stylesheet" type="text/css"/>
...
<div class="logo">
    <a href="Index.php">
        <img src="../metronic/theme/assets/admin/layout3/img/logo-big.png" alt=""/>
    </a>
</div>
<!-- END LOGO -->
...
<div class="content">
    ...
    <form class="login-form" action="Index.php" method="post">
        ...
        <div class="alert alert-danger display-hide">
            ...
            <span>
			Entre com qualquer usuário e senha. </span>
        </div>
        ...
        <div class="create-account">
            <p>
                Não possui uma conta ainda ?&nbsp; <a href="javascript:;" id="register-btn">
                    Crie agora </a>
            </p>
        </div>
    </form>
    ...
    <form class="register-form" action="Index.php" method="post">
        <h3>Inscrever-se</h3>
        <p>
            Digite seus detalhes pessoais abaixo:
        </p>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Confirme sua senha</label>
            <div class="controls">
                <div class="input-icon">
                    <i class="fa fa-check"></i>
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Digite novamente sua senha" name="rpassword"/>
                </div>
            </div>
        </div>
        <div class="form-group">
            <label>
                <input type="checkbox" name="tnc"/> I concordo com  os <a href="javascript:;">
                    Termos de Serviço </a>
                e <a href="javascript:;">
        ...
        <div class="form-actions">
            ...
            <button type="submit" id="register-submit-btn" class="btn green-haze pull-right">
                Registrar-se <i class="m-icon-swapright m-icon-white"></i>
            </button>
        </div>
    </form>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
    <?php echo date("Y");?> &copy; Metronic. Admin Dashboard Template.
</div>
<!-- END COPYRIGHT -->

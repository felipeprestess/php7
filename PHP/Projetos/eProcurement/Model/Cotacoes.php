...
EOT;
                                                    ...
                                                    //echo " {$str_deletar}";
                                                    ?>
                                        <a title="Cotar" data-toggle="modal" data-target="#testemodal" onclick="" href="#testemodal"><i class="fa fa-tag"></i></a>
                                        
<!--                                                    <button title="Cotar" data-toggle="modal" data-target="#testemodal"><i class="fa fa-tag"></i></button>-->
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <a title='Não Cotar' onclick="javascript: if (!confirm('Você realmente deseja marcar como não cotar?')){return false;}" href="Cotacoes.php<?PHP echo"?Acao=NaoCotar&" . NaoCotar::_COD_EMPRESA; ?><?PHP echo "={$value['COD_EMPRESA']}&" . NaoCotar::_CODIGO; ?><?PHP echo "={$value['NUM_OC']}&" . NaoCotar::_TIPO; ?><?PHP echo "=O&".NaoCotar::_ID_FORNECEDOR; ?><?PHP echo "={$value['COD_FORNECEDOR']}>";?>"><i class="fa fa-ban"></i></a>
                                        <?PHP
                                                ...
                                                if ($countItem < 1) {
                                                    echo "<br><input type=\"checkbox\" />Marcar/Desmarcar todos";
                                                }                                  
...
<!--        Deu certo aqui o modal-->

        <div class="modal fade modal-dialog-center" role="dialog" id="testemodal">
...
<!--        <div class="modal fade modal-dialog-center" id="cotacaos" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content-wrap">
                    <div class="modal-content">
                        <form action="Cotacoes.php" method="post" name="cotacao" id="c">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                        ...
                                        <input type="hidden" name="<?PHP //echo Cotacao::_ID;?>" class="form-control" id="Acao" value="<?PHP //echo $Acao; ?>"/>
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <input type="text" tabindex="2" class="form-control" maxlength="15" name="numero" id="numero" disabled="true"/>
                                    </div>
                                    <div class="col-sm-2">
                            ...
                            <div class="modal-footer">
                                ...
                                <button tabindex="9" class="btn btn-success" id="EmailMensagem" name="EmailMensagem" type="submit">Cotar</button>
                            </div>
                        </form>
                    </div>
                </div>

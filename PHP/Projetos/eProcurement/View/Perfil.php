...
if (isset($_POST['Cadastrar'])) {
    $id = CadastraPerfil($_POST);
    $ObjFuncionalidades->Redirecionar("Perfil.php");
}
                                        ...
                                        <div class="panel-heading">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-1">
                                                    ...
                                                    <?PHP if ($Permissoes['PTC0011']['INCLUIR'] == 1) { ?>
                                                        <a class="btn btn-primary" data-toggle="modal" href="Perfil.php?Acao=Inserir"><i class="fa fa-file-o"></i> Novo</a>
                                                    <?PHP } ?>
                                                </div>
                                                <div class="col-lg-4">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        if (isset($_REQUEST['Filtrar'])) {
                                            ...
                                            if ($_REQUEST['filtroPorDesc'] != "") {
                                                ...
                                                if ($SeqFiltro > 0) {
                                                    $Filtro = " AND (" . PERFIL_NOME . " LIKE '%" . strtoupper($_REQUEST['filtroPorDesc']) . "%')";
                                                    $SeqFiltro++;
                                                } else {
                                                    $Filtro = " (" . PERFIL_NOME . " LIKE '%" . strtoupper($_REQUEST['filtroPorDesc']) . "%')";
                                                    $SeqFiltro++;
                                                }
                                            }
...
//montamos o formulario de exclusão
                                                    if ($Permissoes['PTC0011']['LIXEIRA'] == 1) {
                                                        $str_deletar = <<<EOT
<a class="btn btn-danger btn-xs excluiritem"  onclick="javascript: if (!confirm('Você realmente deseja excluir este registro?')){return false;}"  href="Perfil.php?Acao=Deletar&id={$value["{$Indice}"]}" id="{$value["{$Indice}"]}"><i class="fa fa-trash-o"></i> Excluir</a>
EOT;
                                                    }
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <label for="UF"> Administrador </label>
                                                                    <?PHP if ($objPerfil->getAdministrador() == 1) { ?>
                                                                        <input type="checkbox" checked="true" class="form-control"  name="<?PHP echo PERFIL_ADMINISTRADOR; ?>" id="<?PHP echo PERFIL_ADMINISTRADOR; ?>" />
                                                                    <?PHP } else { ?>
                                                                        <input type="checkbox" class="form-control"  name="<?PHP echo PERFIL_ADMINISTRADOR; ?>" id="<?PHP echo PERFIL_ADMINISTRADOR; ?>" />
                                                                    <?PHP } ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label>   </label>
                                                                    <?PHP if (($Acao == "Atualizar" && $Permissoes['PTC0011']['ALTERAR'] == 1) || ($Acao == "Inserir" && $Permissoes['PTC0011']['INCLUIR'] == 1)) { ?>

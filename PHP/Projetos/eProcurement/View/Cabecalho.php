...
<header class="header white-bg">
    ...
    <!--logo start-->
    <a href="index.php" class="logo" >Forge<span style='color:green'> solucoes</span></a>
    <!--logo end-->
            ...
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    <?PHP if ($objUsuario->getImagem() != "") { ?>
                        <img alt="" src="<?PHP echo $objUsuario->getImagem(); ?>">
                    <?PHP } ?>
                    <span class="username"><?PHP echo $objUsuario->getNome(); ?></span>
                    <b class="caret"></b>
                </a>
                <ul class="dropdown-menu extended logout">
                    ...
                    <li><a href="#"><i class="fa fa-bell-o"></i> Notificacoes</a></li>
